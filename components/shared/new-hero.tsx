...
export default function NewHero() {
    return (
        <div className="flex flex-col md:justify-center gap-4">
            <Card className="w-full bg-[url('/Untitled-3@3x.png')] md:bg-[url('/banner@3x.png')] bg-contain bg-no-repeat bg-center md:bg-contain h-[500px] md:h-fit">
                <CardContent className="md:my-auto gap-4 flex flex-col w-full md:w-2/5">
                    ...
                    <Button asChild className="md:min-w-2/5">
